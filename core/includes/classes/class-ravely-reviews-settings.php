 ...
 * 
 * RAVELY->settings->get_plugin_name();
 * 
 * HELPER COMMENT END
 */

/**
 * Class Ravely_Reviews_Settings
 *
 * This class contains all of the plugin settings.
 * Here you can configure the whole plugin data.
 *
 * @package		RAVELY
 * @subpackage	Classes/Ravely_Reviews_Settings
 * @author		Ravely
 * @since		1.0.0
 */
class Ravely_Reviews_Settings{
	...
	/**
	 * Our Ravely_Reviews_Settings constructor 
	...
	public function get_plugin_name(){
		return apply_filters( 'RAVELY/settings/get_plugin_name', $this->plugin_name );
	}
}